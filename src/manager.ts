...
async function update() {
    ...
    activity.assets = {
        large_image: asset[0] || 'https://cdn.discordapp.com/attachments/1223327439363772426/1239001755598192680/T2uB0yYx.png',
        large_text: `on ${lastTrack.album}`,
        small_image: 'https://cdn.discordapp.com/attachments/1223327439363772426/1239002726474580038/UIctL1gK.png',
    };
}
